            ...
            <div className="footer-sections">
                ...
                <div className="footer-section-nav">
                    ...
                    <div className="footer-element">
                        ...
                        <Link href="/dyster"><a className="footer-h3">Præmiedyster</a></Link>
                        <Link href="/blog"><a className="footer-h3">Blog</a></Link>
                    </div>
                    <div className="footer-element">
                ...
                <div className="footer-section" id="footer-nyhedsbrev">
                    ...
                    <div className="footer-felt">
                        <input type="text" className="footer-input" placeholder='Indtast din email' />
                        <button className="footer-btn">Tilmeld</button>
                    </div>
